# Task_8_desktop_application_wpf
...
```
cd existing_repo
git remote add origin https://git.foxminded.ua/foxstudent108992/task_8_desktop_application_wpf.git
git branch -M main
...
* [Set up project integrations](https://git.foxminded.ua/foxstudent108992/task_8_desktop_application_wpf/-/settings/integrations)
